...
function processUserInput() {
  ...
  if (userInput) {
    ...
    if (currentBotMessageIndex < botMessages.length) {
      ...
      const results = `Based on the following data, Please provide recommendations for meditation and yoga practices according to Ayurvedic principles. Include specific practices, duration, frequency, and any other relevant information.
      Data: 
      What is your age: ${answers[1]}
      What is your gender: ${answers[2]}
      What is your body type: ${answers[3]}
      What is your level of experience with meditation and yoga: ${answers[4]}
      What type of yoga practice are you interested in: ${answers[5]}
      What are your primary goals for meditation and yoga practice: ${answers[6]}
      What is your preferred time of day for meditation and yoga practice: ${answers[7]}
      Do you have any physical limitations or health concerns that may affect your practice: ${answers[8]}
      How often do you plan to practice meditation and yoga: ${answers[9]}
      Do you have any specific preferences for meditation or yoga techniques: ${answers[10]}`;
      console.log(results);
...
searchAgain.addEventListener("click", function () {
  ...
  const messageContainer = document.createElement("div");
  messageContainer.innerHTML = `Hi there! I'm Ayurvedic meditation and yoga recommender, here to
  provide personalized meditation and yoga practices based on body
  type and health goals.
  <br /><br />
  What's your name?`;
  chatHistory.appendChild(messageContainer);
  chatHistory.scrollTop = chatHistory.scrollHeight;
