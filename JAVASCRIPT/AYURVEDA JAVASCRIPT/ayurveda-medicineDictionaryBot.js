...
searchButton.addEventListener("click", function () {
  ...
  if (medicineName === "") {
    ...
    const modifiedQuestion = `Please provide information on the ${medicineName} herb or substance used in Ayurveda. Include its scientific name, properties, benefits, and recommended usage based on Ayurvedic principles. You can also provide any related herbs or substances that are often used in combination with this herb.`;
    outputField.innerHTML = "";
